...
**Admin Plugin Access Control** provides essential security and access control for your WordPress site by allowing you to lock down the plugins area. Easily restrict access to plugin activation, deactivation, deletion, and settings pages based on user roles.
...
1. Upload the `admin-plugin-access-control` folder to the `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Navigate to **Admin Plugin Access Control** in the WordPress admin menu to configure your settings.
